...
CONTAINS
   ...
   SUBROUTINE projectSolutionDifferentMeshes_general(T1, X1, T2, X2, u1, q1, u2, q2)
      ...
      IF (PRESENT(q1)) THEN
         ALLOCATE (q1_3D(SIZE(T1, 1)*SIZE(T1, 2), phys%neq, ndim))
         ALLOCATE (q2_3D(SIZE(T2, 1)*SIZE(T2, 2), phys%neq, ndim))
         q1_3D = 0.
         q2_3D = 0.
      END IF
   ...
   END SUBROUTINE projectSolutionDifferentMeshes_general
   ...
   END SUBROUTINE projectSolutionDifferentMeshes_general_arrays
   ...
   SUBROUTINE projectSolutionDifferentMeshes_Mod(T1, X1, T2, X2, u_old, q_old, u_new, q_new)
      ...
      INTEGER                     :: elem_full(SIZE(T1, 1)), ierr
