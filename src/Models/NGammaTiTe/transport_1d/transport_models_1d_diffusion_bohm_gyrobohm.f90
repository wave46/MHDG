...
CONTAINS
  ...
  MODULE SUBROUTINE tm1d_compute_mixed_transport(this, work)
    ...
    particle_factor = this%config%c_bohm_n * &
         MAX(1.d0 - this%config%c_bohm_n_rho_slope*work%rmin_fs/MAX(work%a_minor, model_tol), 0.d0)
    this%d_fs = particle_factor * this%chi_i_fs*this%chi_e_fs / MAX(this%chi_i_fs + this%chi_e_fs, 1.d-10)
