...
export MHDG_HDF5_DIR=$HDF5_DIR

# Set where the libraries are (if common directory)
export MHDG_LIB_DIR=$HOME/local
...
source $MHDG_PASTIX_DIR/bin/pastix_env.sh
export MHDG_SCOTCH_DIR=$MHDG_LIB_DIR/scotch_32
export MHDG_MMG_DIR=$HOME/libs/mmg
export MHDG_GMSH_DIR=$MHDG_LIB_DIR/gmsh_1.11_iopenmpi_2020
